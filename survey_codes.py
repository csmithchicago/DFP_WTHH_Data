...
metadata_dict = {"votereg": {'question': 'Are you registered to vote?',
                             '1': 'Yes',
                             '2': 'No TERMINATE',
                 ...
                 'race': {'question': 'What racial or ethnic group best describes you?',
                          '1': 'White',
                          ...
                          '6': 'Mixed Race',
                          '7': 'Other'},
                 'hispanic': {'question': 'Are you of Spanish, Latino, or Hispanic origin or descent?',
                              '1': 'Yes',
                              '2': 'No'},
                 'pp18_votelikely': {'question': ('On Tuesday, November 6 (ONCE IT IS NOVEMBER 1ST SHOULD'
                 ...
                 'senvote18_undecided': {'question': ('Even though you say you are undecided, if you had to'
                                                       ...
                                                       '15': 'Undecided',
                                                       '16': 'I would not vote'},
                 'specsenvote18': {'question': ('(ASK ONLY IN 2018 SPECIAL ELECTION SENATE STATES) (IF'
                                   ...
                                   '16': 'I would not vote',
                                   '17': 'Prefer not to say'},
                 'specsenvote18_undecided': {'question': ('Even though you say you are undecided, if you had to'
                                                          'choose, would you say you lean more toward '
                                                          '(Candidate A) or (Candidate B)?'),
                                             '8': 'Lean Candidate\'s name (Democrat)',
                                             '10': 'Lean Candidate\'s name (Republican)',
                                             ...
                                             '15': 'Undecided',
                                             '16': 'I would not vote'},
                 'housevote18': {'question': ('If the election for U.S. House of Representatives were being held'
                                 ...
                                 '16': 'I would not vote',
                                 '17': 'Prefer not to say'},
                 'housevote18_undecided': {'question': ('Even though you say you are undecided, if you had to'
                                                        'choose, would you say you lean more toward '
                                                        '(Candidate A) or (Candidate B)?'),
                                           '8': 'Lean Candidate\'s name (Democrat)',
                                           '9': 'Lean Candidate\'s name (2 nd Democrat, if applicable)',
...
# (codes up to housevote18_full, house2_imputed, and house3)
                 'govvote18': {'question': ('(ASK ONLY IN 2018 GOVERNOR STATES) (IF NOT ALREADY VOTED) If'
                               ...
                               '16': 'I would not vote',
                               '17': 'Prefer not to say'},
                 'govvote18_undecided': {'question': ('Even though you say you are undecided, if you had to'
                                                      'choose, would you say you lean more toward '
                                                      '(Candidate A) or (Candidate B)?'),
                                         '8': 'Lean Candidate\'s name (Democrat)',
                                         '10': 'Lean Candidate\'s name (Republican)',
...
# (codes up to govvote18_full)
                 'direct': {'question': ('Generally speaking, do you think that things in this country '
                                         'are going in the right direction, or do you feel things have '
                                         'gotten pretty seriously off on the wrong track?'),
                            '1': 'Right direction',
                            '2': 'Wrong track',
                            '3': 'Not sure'},
                 'favor_labor': {'question': ('labor unions, Please rate your feelings toward each of the people, terms, '
                                 ...
                                 '5': 'Never heard',
                                 '6': 'Don\'t know'},
                 'favor_dem': {'question': ('democratic party, Please rate your feelings toward each of the people, terms, '
                                            'and organizations below: do you feel very favorable toward '
                                            'them, somewhat favorable, somewhat unfavorable, very '
                                            'unfavorable, or have you never heard of them? RANDOMIZE'),
                               '1': 'Very favorable',
                               ...
                               '5': 'Never heard',
                               '6': 'Don\'t know'},
                 'favor_rep': {'question': ('republican party, Please rate your feelings toward each of the people, terms, '
                                            'and organizations below: do you feel very favorable toward '
                                            'them, somewhat favorable, somewhat unfavorable, very '
                                            'unfavorable, or have you never heard of them? RANDOMIZE'),
                               '1': 'Very favorable',
                               ...
                               '5': 'Never heard',
                               '6': 'Don\'t know'},
                 'favor_aca': {'question': ('affordable care act or obamacare, Please rate your '
                               ...
                               '5': 'Never heard',
                               '6': 'Don\'t know'},
                 'favor_dtrump': {'question': ('donald trump, Please rate your feelings toward each of the people, terms, '
                                              'and organizations below: do you feel very favorable toward '
                                              'them, somewhat favorable, somewhat unfavorable, very '
                                              'unfavorable, or have you never heard of them? RANDOMIZE'),
                                 '1': 'Very favorable',
                                 ...
                                 '5': 'Never heard',
                                 '6': 'Don\'t know'},
                 'favor_mcconnell': {'question': ('mitch mcconnell, Please rate your feelings toward each of the people, terms, '
                                                  'and organizations below: do you feel very favorable toward '
                                                  'them, somewhat favorable, somewhat unfavorable, very '
                                                  'unfavorable, or have you never heard of them? RANDOMIZE'),
                                     '1': 'Very favorable',
                                     ...
                                     '5': 'Never heard',
                                     '6': 'Don\'t know'},
                 'favor_demcong': {'question': ('dems in congress, Please rate your feelings toward each of the people, terms, '
                                                'and organizations below: do you feel very favorable toward '
                                                'them, somewhat favorable, somewhat unfavorable, very '
                                                'unfavorable, or have you never heard of them? RANDOMIZE'),
                                   '1': 'Very favorable',
                                   ...
                                   '5': 'Never heard',
                                   '6': 'Don\'t know'},
                 'favor_repcong': {'question': ('repub in congress, Please rate your feelings toward each of the people, terms, '
                                                'and organizations below: do you feel very favorable toward '
                                                'them, somewhat favorable, somewhat unfavorable, very '
                                                'unfavorable, or have you never heard of them? RANDOMIZE'),
                                   '1': 'Very favorable',
                                   ...
                                   '5': 'Never heard',
                                   '6': 'Don\'t know'},
                 'favor_metoo': {'question': ('\#metoo, Please rate your feelings toward each of the people, terms, '
                                              'and organizations below: do you feel very favorable toward '
                                              'them, somewhat favorable, somewhat unfavorable, very '
                                              'unfavorable, or have you never heard of them? RANDOMIZE'),
                                 '1': 'Very favorable',
                                 ...
                                 '5': 'Never heard',
                                 '6': 'Don\'t know'},
                 'favor_blm': {'question': ('Black lives matter, Please rate your feelings toward each of the people, terms, '
                                            'and organizations below: do you feel very favorable toward '
                                            'them, somewhat favorable, somewhat unfavorable, very '
                                            'unfavorable, or have you never heard of them? RANDOMIZE'),
                               '1': 'Very favorable',
                               ...
                               '5': 'Never heard',
                               '6': 'Don\'t know'},
                 'app_dtrmp': {'question': ('Do you approve or disapprove of the way Donald Trump '
                               ...
                               '5': 'Not sure'},
                 'suprpty': {'question': 'Which of the following best describes you?',
                             '1': 'I have always been a supporter of the Democratic Party',
                             '2': ('I was a supporter of the Republican Party, but have switched '
                                   'to supporting the Democratic Party'),
                             '3': ('I was a supporter of the Democratic Party, but have switched '
                                   'to supporting the Republican Party'),
                             '4': 'I have always been a supporter of the Republican Party',
                             '5': 'Not sure'},
                 'campaign_contact_emails': {'question': 'Have you, Received emails from a campaign, organization or group',
                 ...
                 'campaign_contact_text': {'question': 'Have you, Received a text message from a campaign, organization or group',
                                           '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                           '2': 'Yes, contacted by a Republican or Republican leaning group',
                                           '3': 'Yes, contacted by both',
                                           '4': 'No, not contacted that way'},
                 'campaign_contact_mailer': {'question': ('Have you, Received printed materials in the mail '
                                                          'from a campaign, organization or group'),
                                             '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                             '2': 'Yes, contacted by a Republican or Republican leaning group',
                                             '3': 'Yes, contacted by both',
                                             '4': 'No, not contacted that way'},
                 'campaign_contact_onlineads': {'question': 'Have you, Saw political ads online',
                                                '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                                '2': 'Yes, contacted by a Republican or Republican leaning group',
                                                '3': 'Yes, contacted by both',
                                                '4': 'No, not contacted that way'},
                 'campaign_contact_inperson': {'question': ('Have you, Spoke in person with someone from a campaign,'
                                                            'organization or group'),
                                               '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                               '2': 'Yes, contacted by a Republican or Republican leaning group',
                                               '3': 'Yes, contacted by both',
                                               '4': 'No, not contacted that way'},
                 'campaign_contact_phone': {'question': 'Have you, Received phone calls from a campaign, organization or group',
                                            '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                            '2': 'Yes, contacted by a Republican or Republican leaning group',
                                            '3': 'Yes, contacted by both',
                                            '4': 'No, not contacted that way'},
                 'campaign_contact_TVads': {'question': 'Have you, Saw political ads on television',
                                            '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                            '2': 'Yes, contacted by a Republican or Republican leaning group',
                                            '3': 'Yes, contacted by both',
                                            '4': 'No, not contacted that way'},
                 'campaign_contact_socialmedia': {'question': ('Have you, Contacted by a campaign, organization or group'
                                                               'through social media'),
                                                  '1': 'Yes, contacted by a Democrat or Democratic leaning group',
                                                  '2': 'Yes, contacted by a Republican or Republican leaning group',
                                                  '3': 'Yes, contacted by both',
                                                  '4': 'No, not contacted that way'},
                 'VOTE_GEN': {'question': 'In general, how often do you vote?',
                              '1': 'I always vote',
                              '2': 'I usually vote',
                              '3': 'I sometimes vote',
                              '4': 'I rarely vote',
                 ...
                 'NONVOTE_WHY_1': {'question': ('I didn\'t feel like I knew enough to make an informed decision '
                                                'between the candidates'),
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_2': {'question': 'I didn\'t feel that any of the candidates represented my views',
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_3': {'question': 'I wanted to vote, but wasn\'t registered',
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_4': {'question': 'I wanted to vote, but didn\'t have time/was too busy that day',
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_5': {'question': 'I wanted to vote, but couldn\'t find my polling location',
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_6': {'question': 'I wanted to vote, but didn\'t have a required form of identification',
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_7': {'question': 'Other',
                                   '1': 'Yes',
                                   '2': 'No'},
                 'NONVOTE_WHY_t': {'question': ('Reason for not voting in past elections')},
                 'VOTECONF': {'question': ('if turnout16 == 1 How confident are you that your vote in the '
                 ...
                 'GENERATIONS': {'question': ('Please indicate the extent to which you agree with each of the'
                                 ...
                                 '5': 'Strongly disagree',
                                 '6': 'No opinion'},
                 'FAVORS': {'question': ('Please indicate the extent to which you agree with each of the following'
                            ...
                            '5': 'Strongly disagree',
                            '6': 'No opinion'},
                 'INSTITUTION': {'question': ('Please indicate the extent to which you agree with each of the'
                                 ...
                                 '5': 'Strongly disagree',
                                 '6': 'No opinion'},
                 'SYSTEM': {'question': ('Please indicate the extent to which you agree with each of the following'
                            ...
                            '5': 'Strongly disagree',
                            '6': 'No opinion'},
                 'EMPATHY': {'question': ('Please indicate the extent to which you agree with each of the following'
                             ...
                             '5': 'Strongly disagree',
                             '6': 'No opinion'},
                 'racial_resentment_raw': {'question': ('(recode) Coded from GENERATIONS, FAVORS, INSTITUTION,'
                                                        ...
                                                        'GENERATIONS.')},
                 'racial_resentment_scaled': {'question': ('(recode) Sum of racial_animus_scaled divided by its '
                                                           'maximum value.')},
...
# warm or positive).
                 'FT_Whites': {'question': ('Whites Rate your feeling toward this group from zero '
                                            '(very cold or negative) to 100 (very warm or positive).')},
                 'FT_Blacks': {'question': ('Blacks Rate your feeling toward this group from zero (very '
                                            'cold or negative) to 100 (very warm or positive).')},
                 'FT_Latinos': {'question': ('Latinos Rate your feeling toward this group from zero '
                                             '(very cold or negative) to 100 (very warm or positive).')},
...
# can be rated.
                 'LAZY_Whites': {'question': 'How lazy or hardworking is each group? Whites',
                                 '1': 'Very lazy',
                                 '2': 'Lazy',
                                 '3': 'Somewhat lazy',
                                 ...
                                 '6': 'Hardworking',
                                 '7': 'Very hardworking'},
                 'LAZY_Blacks': {'question': 'How lazy or hardworking is each group? Blacks',
                                 '1': 'Very lazy',
                                 '2': 'Lazy',
                                 '3': 'Somewhat lazy',
                                 '4': 'Neither lazy nor hardworking',
                                 ...
                                 '6': 'Hardworking',
                                 '7': 'Very hardworking'},
                 'LAZY_Latinos': {'question': 'How lazy or hardworking is each group? Latinos',
                                  '1': 'Very lazy',
                                  '2': 'Lazy',
                                  '3': 'Somewhat lazy',
                                  '4': 'Neither lazy nor hardworking',
                                  ...
                                  '6': 'Hardworking',
                                  '7': 'Very hardworking'},
                 'INTELLIGENT_Whites': {'question': 'How intelligent or unintelligent is each group? Whites',
                                        '1': 'Very intelligent',
                                        '2': 'Intelligent',
                 ...
                 'INTELLIGENT_Blacks': {'question': 'How intelligent or unintelligent is each group? Blacks',
                                        '1': 'Very intelligent',
                                        '2': 'Intelligent',
                                        '3': 'Somewhat intelligent',
                                        '4': 'Neither intelligent nor unintelligent',
                                        ...
                                        '6': 'Unintelligent',
                                        '7': 'Very unintelligent'},
                 'INTELLIGENT_Latinos': {'question': 'How intelligent or unintelligent is each group? Latinos',
                                         '1': 'Very intelligent',
                                         '2': 'Intelligent',
                                         '3': 'Somewhat intelligent',
                                         '4': 'Neither intelligent nor unintelligent',
                                         ...
                                         '6': 'Unintelligent',
                                         '7': 'Very unintelligent'},
                 'RACE_IDENT': {'question': 'How important is being $race to your identity?',
                                '4': 'Very important',
                 ...
                 'LINKFATE': {'question': ('Please indicate the extent to which you agree with the following'
                              ...
                              '4': 'Somewhat disagree',
                              '5': 'Strongly disagree'},
                 'FINPREP': {'question': ('Thinking about your household\'s finances today, could you '
                 ...
                 'JOBS': {'question': ('As you may know, Census projections show that by 2043 African Americans,'
                          ...
                          '5': 'Strongly disagree',
                          '6': 'Not sure'},
                 'fear_of_demographic_change_raw': {'question': ('(recode) Coded from ENRICH, SERVICES,'
                 ...
                 'PATH': {'question': ('Please indicate whether you favor or oppose each of the '
                          ...
                          '5': 'Strongly oppose',
                          '6': 'Don\'t know'},
                 'BORDER': {'question': ('Please indicate whether you favor or oppose each of '
                 ...
                 'SOCIALDOMINANCE_PRIORITIES': {'question': 'In setting priorities, we must consider all groups',
                                                '1': 'Strongly agree',
                                                '2': 'Somewhat agree',
                                                '3': 'Neither agree nor disagree',
                                                '4': 'Somewhat disagree',
                                                '5': 'Strongly disagree'},
                 'SOCIALDOMINANCE_NOTPUSH': {'question': 'We should not push for group equality',
                                             '1': 'Strongly agree',
                                             '2': 'Somewhat agree',
                                             '3': 'Neither agree nor disagree',
                                             '4': 'Somewhat disagree',
                                             '5': 'Strongly disagree'},
                 'SOCIALDOMINANCE_EQUALIDEAL': {'question': 'Group equality should be our ideal',
                                                '1': 'Strongly agree',
                                                '2': 'Somewhat agree',
                                                '3': 'Neither agree nor disagree',
                                                '4': 'Somewhat disagree',
                                                '5': 'Strongly disagree'},
                 'SOCIALDOMINANCE_SUPERIOR': {'question': 'Superior groups should dominate inferior groups',
                                              '1': 'Strongly agree',
                                              '2': 'Somewhat agree',
                                              '3': 'Neither agree nor disagree',
                                              '4': 'Somewhat disagree',
                 ...
                 'APPRECIATE': {'question': ('Please indicate the extent to which you agree with the following'
                                ...
                                '5': 'Strongly disagree',
                                '6': 'Don\'t know'},
                 'hostile_sexism_raw': {'question': ('(recode) Coded from REMARKS, OFFEND, APPRECIATE.'
                 ...
                 'hostile_sexism_scaled': {'question': '(recode) Sum of hostile_sexism_raw divided by its maximum value.'},
                 'GENDERPERSONALITY_INDEP': {'question': ('Select the number that describes where you fall on '
                                                          'the scale between the two characteristics. 1 = Not '
                                                          'at all independent; 5 = Very independent')},
                 'GENDERPERSONALITY_EMOT': {'question': ('Select the number that describes where you fall on '
                                                         'the scale between the two characteristics. '
                                                         '1 = Not at all emotional; 5 = Very emotional')},
                 'GENDERPERSONALITY_CONFIDENT': {'question': ('Select the number that describes where you fall on '
                                                              'the scale between the two characteristics. '
                                                              '1 = Very Confident; 5 = Not at all confident')},
                 'GENDERPERSONALITY_HELPFUL': {'question': ('Select the number that describes where you fall '
                                                            'on the scale between the two characteristics. '
                                                            '1 = Not at all helpful to others; 5 = Very helpful to others')},
                 'GENDERPERSONALITY_DECISIONS': {'question': ('Select the number that describes where you fall '
                                                              'on the scale between the two characteristics. '
                 ...
                 'POP_3': {'question': ('Please indicate the extent to which you agree with the following statement:'
                           ...
                           '5': 'Strongly disagree',
                           '6': 'Not sure'},
                 'ICE': {'question': 'Would you support or oppose defunding Immigration and Customs Enforcement (ICE)?',
                         '1': 'Strongly support',
                         '2': 'Somewhat support',
                         '3': 'Neither support nor oppose',
                         '4': 'Somewhat oppose',
                         '5': 'Strongly oppose',
                         '6': 'Not sure'},
                 'BAIL_item': {'question': ('Would you support or oppose ending cash bail for individuals awaiting'
                               ...
                               '5': 'Strongly oppose',
                               '6': 'Not sure'},
                 'WELTEST': {'question': ('Would you support or oppose requiring recipients of government aid'
                 ...
                 'PUBLICINT': {'question': ('Would you support or oppose the creation of a publicly-owned Internet'
                               ...
                               '5': 'Strongly oppose',
                               '6': 'Not sure'},
                 'GREENJOB': {'question': ('Would you support or oppose giving every unemployed American who'
                              ...
                              '5': 'Strongly oppose',
                              '6': 'Not sure'},
                 'POLFEE': {'question': ('Would you support or oppose a policy to charge pollution fees on '
                 ...
                 'FREECOLL': {'question': ('Would you support or oppose a law that would raise taxes on income'
                              ...
                              '5': 'Strongly oppose',
                              '6': 'Not sure'},
                 'WEALTH': {'question': 'Would you support or oppose a tax on wealth greater than $100 million?',
                            '1': 'Strongly support',
                            '2': 'Somewhat support',
                            '3': 'Neither support nor oppose',
                            '4': 'Somewhat oppose',
                 ...
                 'MARAM': {'question': ('Some people are currently incarcerated for marijuana-related offenses in'
                           ...
                           '5': 'Strongly oppose',
                           '6': 'Not sure'},
                 'MARLEG': {'question': 'Would you support or oppose fully legalizing marijuana at the national level?',
                            '1': 'Strongly support',
                            '2': 'Somewhat support',
                            '3': 'Neither support nor oppose',
                            '4': 'Somewhat oppose',
                 ...
                 'YEMEN': {'question': ('The United States is currently providing military equipment and logistical'
                           ...
                           '5': 'Strongly oppose',
                           '6': 'Not sure'},
                 'SOLITARY': {'question': ('Would you support or oppose ending the practice of solitary '
                              ...
                              '5': 'Strongly oppose',
                              '6': 'Not sure'},
                 'GUNS': {'question': 'Which of the following is closest to your view on gun regulations?',
                 ...
                 'NDIVERSE': {'question': ('Compared to other places near where you live, '
                                           'would you say your neighborhood is more diverse, or more homogeneous? '
                                           '1 = More diverse; 10 = More homogeneous')},
                 'NDEMS': {'question': ('About what percentage of the people who live in your neighborhood do'
                 ...
                 'SOURCES_1':  {'question': ('In the past week, did you get news from CNN'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_2':  {'question': ('In the past week, did you get news from Fox News'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_3':  {'question': ('In the past week, did you get news from MSNBC'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_4':  {'question': ('In the past week, did you get news from Other Cable News TV Networks'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_5':  {'question': ('In the past week, did you get news from Local TV News'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_6':  {'question': ('In the past week, did you get news from National nightly network TV news'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_7':  {'question': ('In the past week, did you get news from News websites or apps'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_8':  {'question': ('In the past week, did you get news from Your local daily print newspaper'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_9':  {'question': ('In the past week, did you get news from National print newspapers'),
                                '1': 'Yes',
                                '2': 'No'},
                 'SOURCES_10':  {'question': ('In the past week, did you get news from News on the radio'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_11':  {'question': ('In the past week, did you get news from Late night comedy shows'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_12':  {'question': ('In the past week, did you get news from Facebook'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_13':  {'question': ('In the past week, did you get news from Twitter'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_14':  {'question': ('In the past week, did you get news from Reddit'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_15':  {'question': ('In the past week, did you get news from YouTube'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_16':  {'question': ('In the past week, did you get news from Other social media '
                                              'such as LinkedIn, Instagram, or Snapchat'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'SOURCES_17':  {'question': ('In the past week, did you get news from None of these'),
                                 '1': 'Yes',
                                 '2': 'No'},
                 'pid3': {'question': 'Generally speaking, do you think of yourself as a ...?',
                          '1': 'Democrat',
                          '2': 'Republican',
                          '3': 'Independent',
                          '4': 'Other',
                          '5': 'Not sure'},
                 'pid7_dems': {'question': 'Would you call yourself a strong Democrat or a not very strong Democrat?',
                               '1': 'Strong Democrat',
                               '2': 'Not very strong Democrat'},
                 'pid7_reps': {'question': 'Would you call yourself a strong Republican or a not very strong Republican?',
                               '6': 'Not very strong Republican',
                               '7': 'Strong Republican'},
                 'pid7_oths': {'question': 'Do you think of yourself as closer to the Democratic or the Republican Party?',
                               '3': 'The Democratic Party',
                               '5': 'The Republican Party',
                               '4': 'Neither',
                               '8': 'Not sure'},
                 'pid7': {'question': 'Generally speaking, do you think of yourself as a ...?',
                          '1': 'Strong Democrat',
                          '2': 'Not very strong Democrat',
                          '3': 'Lean Democrat',
                          '4': 'Independent',
                          ...
                          '7': 'Strong Republican',
                          '8': 'Not sure'},
                 'dtrpsupp': {'question': ('(ASK ONLY REPUBLICANS) Do you consider yourself more a supporter'
                              ...
                              '5': 'Not sure'},
                 'ideo5': {'question': 'In general, how would you describe your own political viewpoint?',
                           '1': 'Very liberal',
                           '2': 'Liberal',
                           '3': 'Moderate',
                           '4': 'Conservative',
                           '5': 'Very conservative',
                           '6': 'Not sure'},
                 'turnout16': {'question': 'Did you vote in the election on Tuesday, November 8, 2016?',
                               '1': 'Yes',
                               '2': 'No'},
                 'presvote16post': {'question': 'ask if turnout16=1 Who did you vote for in the election for President?',
                                    '1': 'Hillary Clinton',
                                    '2': 'Donald Trump',
                                    '3': 'Gary Johnson',
                                    '4': 'Jill Stein',
                 ...
                 'djtrelct': {'question': ('Regardless of how you voted in 2016, with the information you have now,'
                                           ' would you vote to re-elect Donald Trump in 2020?'),
                              '1': 'Yes',
                              '2': 'No',
                              '3': 'Not sure'},
                 'housevote16post': {'question': ('ask if turnout16=1 In the election for U.S. House of'
                 ...
                 'e14_presvote12': {'question': ('ask if birthyr < 1995 and votereg in 1 Which candidate did you'
                                                 ' vote for in the 2012 Presidential election?'),
                                    '1': 'Barack Obama',
                                    '2': 'Mitt Romney',
                                    '3': 'Other candidate',
                                    '4': 'I did not vote'},
                 'union_combined_1': {'question': 'Yes, current union member',
                                      '2': 'No',
                                      '1': 'Yes'},
                 'union_combined_5': {'question': 'Yes, retired unionmember',
                                      '2': 'No',
                                      '1': 'Yes'},
                 'union_combined_2': {'question': 'Yes, someone in household is a current union member',
                                      '2': 'No',
                                      '1': 'Yes'},
                 'union_combined_6': {'question': 'Yes, someone in household is a retired union member',
                                      '2': 'No',
                                      '1': 'Yes'},
                 'union_combined_3': {'question': 'No one in household is a union member',
                                      '2': 'No',
                                      '1': 'Yes'},
                 'union_combined_4': {'question': 'Not sure if anyone in household is or has been a union member',
                                      '2': 'No',
                                      '1': 'Yes'},
                 'marstat': {'question': 'What is your marital status?',
                             '1': 'Married',
                             '2': 'Separated',
                             '3': 'Divorced',
                             '4': 'Widowed',
                 ...
                 'child18': {'question': 'Are you the parent or guardian of any children under the age of 18?',
                             '1': 'Yes',
                             '2': 'No'},
                 'religpew': {'question': 'What is your present religion, if any?',
                              '1': 'Protestant',
                              '2': 'Roman Catholic',
                              '3': 'Mormon',
                              ...
                              '12': 'Something else'},
                 'pew_bornagain': {'question': ('Would you describe yourself as a “born-again” or '
                                                'evangelical Christian, or not?'),
                                   '1': 'Yes',
                                   '2': 'No'},
                 'pew_churatd': {'question': ('Aside from weddings and funerals, how often do you attend religious'
                                              'services?'),
                                 ...
                                 '6': 'Never',
                                 '7': 'Don\'t know'},
                 'employ': {'question': 'Which of the following best describes your current employment status?',
                            ...
                            '8': 'Student',
                            '9': 'Other job'},
                 'faminc_new': {'question': 'Thinking back over the last year, what was your family\'s annual income?',
                                '1': 'Less than $10,000',
                                '2': '$10,000 - $19,999',
                                '3': '$20,000 - $29,999',
                                '4': '$30,000 - $39,999',
                 ...
                 'educ2': {'question': '(recode) What is the highest level of education you have completed?',
                           '1': 'Less than college',
                           '2': 'College'},
                 'educ4': {'question': '(recode) What is the highest level of education you have completed?',
                           '1': 'High school or less',
                           '2': 'Some college',
                           '3': 'College grad',
                           '4': 'Postgrad'},
                 'age5': {'question': '(recode) What is your age?',
                          '1': '18-29',
                          '2': '30-39',
                          '3': '40-49',
                          '4': '50-64',
                          '5': '65+'},
                 'race4': {'question': '(recode) What racial or ethnic group best describes you?',
                           '1': 'White',
                           '2': 'Black',
                           '3': 'Hispanic',
                           '4': 'Other'},
                 'race3': {'question': '(recode) What racial or ethnic group best describes you?',
                           '1': 'White/other',
                           '2': 'Black',
                           '3': 'Hispanic'},
                 ...
                 'pp18_polactions_1': {'question': ('Volunteered for a candidate, political party, or other political '
                                       ...
                                       '2': 'No',
                                       '1': 'Yes'},
                 'pp18_polactions_2': {'question': ('In the last 6 months have you attended a rally or protest'),
                                       '2': 'No',
                                       '1': 'Yes'},
                 'pp18_polactions_3': {'question': ('In the last 6 months have you, called or wrote to an '
                                                    'elected official'),
                                      '2': 'No',
                                      '1': 'Yes'},
                 'pp18_polactions_4': {'question': ('In the last 6 months have you, attended a town hall held '
                                                    'by an elected official'),
                                       '2': 'No',
                                       '1': 'Yes'},
                 'pp18_polactions_5': {'question': ('In the last 6 months have you, posted about politics on '
                                                    'social media'),
                                       '2': 'No',
                                       '1': 'Yes'},
                 'pp18_polactions_6': {'question': ('In the last 6 months have you, made a donation to a candidate, '
                                                    'party, or other political organization'),
                                       '2': 'No',
                                       '1': 'Yes'},
                 'pp18_polactions_7': {'question': ('In the last 6 months have you, Other'),
                                       '2': 'No',
                                       '1': 'Yes'},
                 'pp18_polactions_8': {'question': ('In the last 6 months have you, I have not done any of the above')},
                 'weight_DFP': {'question': ('The sample was weighted according to age, sex, race, education, '
